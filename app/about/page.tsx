                            ...
                            <div className="p-6 bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl hover:bg-white/10 transition-all group">
                                ...
                                <div className="p-2 px-4 gap-2 flex justify-center items-center">
                                    <div className="text-xl text-blue-500">
                                        ...
                                        <p className='text-xl mt-1 text-white-500 '>Html5</p>
                                </div>
                                ...
                                <div className="p-2 px-4 gap-2 flex justify-center items-center">
                                    <div className="text-xl text-blue-500">
                                        ...
                                        <p className='text-xl mt-1 text-white-500 '>CSS</p>
                                </div>

                                <div className="p- px- gap-4 flex justify-center items-center ">
                                    <div className=" text-xl text-yellow-500">
                                        <SiJavascript/>
                                    </div>
                                        <p className='text-xl mt-1 text-white'>JavaScript</p>
                                </div>
                                ...
                                <div className="p-2 px-4 gap-2 flex justify-center items-center ">
                                    <div className="text-xl text-blue-500">
                                        ...
                                        <p className='text-xl mt-1 text-white-500 '>TypeScript</p>
                                </div> 
                                ...
                                <div className="p-2  px-4 gap-2 flex justify-center items-center">
                                    <div className=" text-3xl text-blue-500">
                                        ...
                                        <p className='text-xl mt-1 text-white-500'>Tailwind</p>
                                </div>
                                ...
                                <div className="p-2 px-4 gap-2 flex justify-center items-center">
                                    <div className="text-xl text-blue-500">
                                        ...
                                        <p className='text-xl mt-1 text-white-500 '>React</p>
                                </div>                        
                                ...
                                <div className="p-2 px-4 gap-2 flex justify-center items-center  ">
                                    <div className="text-xl">
                                        ...
                                        <p className="text-xl mt-1 text-white-500">Next.js(App Router)</p>
                                </div>
                                ...
                                <div className="p-2 px-4 gap-2 flex justify-center items-center">
                                    <div className="text-xl text-red-500">
                                        ...
                                        <p className='text-xl mt-1 text-white '>Figma</p>
                                </div>   
                                ...
                                <div className="text-5xl flex flex-wrap justify-center gap-5">
                                    ...
                                    <div className="p-2 px-4 gap-2 flex justify-center items-center">
                                        <div className=" text-lg text-amber-700">
                                            ...
                                            <p className='text-lg mt-1 text-white'>Postman</p>
                                    </div>
